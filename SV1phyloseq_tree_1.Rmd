...
```{r}
disc <- read_excel("../20250512_OTU tables_percohort_sepsis prediction model.xlsx", sheet = "SV 1")
disc_otus_t <- t(disc)
...
# Save to file
write.csv(otu_mapping, "otu_id_mappingSV1.csv", row.names = FALSE)
...
Save object:
```{r}
saveRDS(physeq1, 'phyloseq_val_one.rds')
```
