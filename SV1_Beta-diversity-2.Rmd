...
print(stats_disease )
#write_xlsx(stats_disease , "figs/SV1-PCoA_time_window_stats.xlsx")
...
## ---------------------------
ggsave(
  "figs/SV1-PCoA_subgroup_time_windows.png",
  final_subgroup,
  width = 14,
  height = 4,
  dpi = 300
...
## ---------------------------
ggsave(
  "figs/SV1_beta_Pathogen_PCoA_time_windows.png",
  final_plot,
  width = 14,
  height = 4,
  dpi = 300
...
write_xlsx(
  ...
  "figs/SV1_PERMANOVA_all_results.xlsx"
)
