...
write_xlsx(
  lmm_results,
  "savefiles/DC_ControlsvsSepsis_Alpha_diversity_LMM_by_timeperiod.xlsx"
)
...
write_xlsx(
  lmm_results,
  "savefiles/DC_Control_vs_SAureus_Alpha_diversity_LMM_by_timeperiod.xlsx"
)
...
# ===============================
#  Fit linear-mixed effects models (true LMM)
# ===============================
lmm_models <- list(
...
# ===============================
#  Extract Control vs E.coli contrasts
# ===============================
...
write_xlsx(
  lmm_results,
  "savefiles/DC_Control_vs_Ecoli_Alpha_diversity_LMM_by_timeperiod.xlsx"
)
...
# ===============================
#  Recode for Control vs Gut-derived LOS
# ===============================
alpha_df <- p$data %>%
...
# ===============================
#  Extract Control vs Gut-derived LOS contrasts
# ===============================
lmm_results <- lapply(names(lmm_models), function(m) {
...
write_xlsx(
  lmm_results,
  "savefiles/DC_Control_vs_GutDerived_Alpha_diversity_LMM_by_timeperiod.xlsx"
)
...
write_xlsx(
  ...
  "savefiles/DC_Alpha_diversity_3group_LMM.xlsx"
)
