...
phy.red <- readRDS("SV2phyloseq_disc_red.rds")
phy.red
...
#ggsave(  "figs/alpha_LOS_vs_Control.png",  alpha_plot,  height = 5,  width = 12,  dpi = 300)
...
write_xlsx(
  lmm_results,
  "savefiles/SV2_ControlsvsSepsis_Alpha_diversity_LMM_by_timeperiod.xlsx"
)
...
write_xlsx(
  lmm_results,
  "savefiles/SV2_Control_vs_SAureus_Alpha_diversity_LMM_by_timeperiod.xlsx"
)
...
write_xlsx(
  lmm_results,
  "savefiles/SV2_Control_vs_Ecoli_Alpha_diversity_LMM_by_timeperiod.xlsx"
)
...
write_xlsx(
  lmm_results,
  "savefiles/SV2_Control_vs_GutDerived_Alpha_diversity_LMM_by_timeperiod.xlsx"
)
...
write_xlsx(
  ...
  "savefiles/SV2_Alpha_diversity_3group_LMM.xlsx"
)
